...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/oxyda-fox/V3N0M0U5.git"
)
...
IMG = os.environ.get(
    "IMG",
    "https://telegra.ph/file/103f55566ea9d9ac52b4a.jpg")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply(
                    f"Create your own bot, because you can't use this bot anymore.\n\n©V3N0M0U5_T34M\nLeader: ₆⁶₆Ϋ̙Θ⃬UN͠GB⃭ØΫ̘₆⁶₆"
                )
            else:
                await event.reply("[V3N0M0U5](https://telegram.me/V3N0M0U5) ALWAYS WITH YOU!")
            ...
            if event.query.user_id == uid and query.startswith("@GengKapak"):
                ...
                result = builder.article(
                    ...
                    text="{}\nTotal loaded modules: {}".format(
                        "V3N0M0U5 UserBot by @ybay911\n\nGitHub Repository [Here](https://github.com/oxyda-fox/V3N0M0U5)\n",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
...
You can convert your account to bot and use them. Remember, you can't manage someone else's bot! All installation details are explained from GitHub address below.""",
                    buttons=[
                        ...
                        [
                            custom.Button.url(
                                "GitHub",
                                "https://github.com/oxyda-fox/V3N0M0U5")],
                    ],
                    link_preview=False,
                )
